...
public class UserTest2 {
	...
	public void testPostUser() throws JsonProcessingException
	{
		...
		Response response=UserEndPoints2.createUser(userPlayload);
	...
	public void testGetUserByName()
	{
		...
		Response response=UserEndPoints2.readUser(userPlayload.getUsername());
		response.then().log().all();
	...
	public void testUpdateUserByName()
	{
		...
		Response response=UserEndPoints2.updateUser(userPlayload.getUsername(), userPlayload);
		response.then().log().all();
		assertEquals(response.getStatusCode(), 200);
	...
	public void testDeleteUserByName()
	{
		...
		Response response=UserEndPoints2.deleteUser(userPlayload.getUsername());
		response.then().log().all();
		assertEquals(response.getStatusCode(), 200);
